  ...
  return (
    <div className="grid grid-cols-3 gap-8 p-8 lg:p-24 place-items-end">
      <div className="col-span-3 md:col-span-2 lg: lg:col-span-1 justify-self-start">
        <h2 className="font-raleway text-4xl lg:text-5xl font-thin whitespace-pre-line w-full">GET THE</h2>
        <h2 className="font-lora text-4xl lg:text-5xl font-normal italic whitespace-pre-line w-full">LATEST NEWS</h2>
      </div>
